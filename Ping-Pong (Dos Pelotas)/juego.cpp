...
Paleta<int> paletaV1;
Paleta<int> paletaV2;
Pelota<int,float> pelota1V;
Pelota<int,float> pelota2V;
...
void setter_de_clases ()
{
    ...
    resetPelota1( pelota1V , funcionV );
    resetPelota2( pelota2V , funcionV );
    pelota1V.setVelX( 5 );
    pelota1V.setVelY( 5 );
    pelota1V.setVel( 5 );
    pelota1V.setAlto( 15 );
    pelota1V.setAncho( 15 );
    pelota2V.setVelX( 2 );
    pelota2V.setVelY( 2 );
    pelota2V.setVel( 2 );
    pelota2V.setAlto( 15 );
    pelota2V.setAncho( 15 );
    paletaV1.setX( 0 );
...
void loop_del_juego ( )
{
    ...
    while( ! funcionV.getVentana() )
    {
        ...
        while( funcionV.getTiempo() > 0 )
        {
            ...
            //FUNCIONES VARIAS
            moverPelota( pelota1V , pelota2V , paletaV1 , paletaV2 , jugadoresV , funcionV , bits[0].mapa_de_bits , bits[9].mapa_de_bits , bits[10].mapa_de_bits , audio[4].muestra_de_audio , audio[5].muestra_de_audio , audio[6].muestra_de_audio , audio[1].muestra_de_audio , audio[2].muestra_de_audio );
        ...
        dibujar_pelota1( bits[0].mapa_de_bits , pelota1V );
        dibujar_pelota2( bits[0].mapa_de_bits , pelota2V );
        ...
        else if( funcionV.getContador() < 12 )
        {
            ...
            {
                textprintf_ex( bits[0].mapa_de_bits , font , 340 , 250 , 0xD1D1D1 , -1 , "CAMBIO DE NIVEL!! VELOCIODAD AUMENTADA!!" );
                textprintf_ex( bits[0].mapa_de_bits , font , 350 , 270 , 0xD1D1D1 , -1 , "RESET DE PUNTOS - 5 PARA CADA JUGADOR" );
            }
        ...
        {
            if( funcionV.getMensaje() == 1  && funcionV.getContador() == 16 )
            {
                textprintf_ex( bits[0].mapa_de_bits , font , 340 , 250 , 0xD1D1D1 , -1 , "CAMBIO DE NIVEL!! VELOCIODAD AUMENTADA!!" );
            }
            funcionV.setNivel( 5 );
